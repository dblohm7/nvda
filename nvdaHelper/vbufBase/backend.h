...
/**
 * A SendMessage callback that will notify us when VBuf rendering has completed.
 */
  static VOID CALLBACK renderThread_initComplete(HWND hwnd, UINT msg, ULONG_PTR data, LRESULT lResult);
